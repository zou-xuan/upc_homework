...
void create_hash_table(int64_t nEntries, memory_heap_t *memory_heap,hash_table_t *result) {
    // hash_table_t *result;
...
int add_kmer(hash_table_t *hashtable, memory_heap_t *memory_heap, const unsigned char *kmer, char left_ext,
